...
def crearNotasConjuntas (listaNombres, notas1, notas2):
    alumnos = {}
...
notasConjuntas = crearNotasConjuntas(listaNombres, notas_1, notas_2)
print(notasConjuntas) #lo imprimo primero entero y despues alumno por alumno para que sea mas legible
print("Notas de los alumnos: ")
for clave, valor in notasConjuntas.items():
    print(f"alumno: {clave:<20}. Nota1: {valor[0]:<20}, Nota2: {valor[1]:<20}")

print ("-" * 70)
print("Promedio de cada alumno: ")
promedioAlumnos = calcularPromedio(notasConjuntas)
for alumno, promedio in promedioAlumnos.items():
    print (f"Alumno: {alumno:<20}, Promedio: {promedio:<20}")
...
print(f"El estudiante con la nota mas baja es {notaMasBaja(notasConjuntas)}")
